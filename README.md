...
```vue
<line-chart :data="{'2026-01-01': 11, '2026-01-02': 6}"></line-chart>
```
...
```vue
<area-chart :data="{'2026-01-01': 11, '2026-01-02': 6}"></area-chart>
```
...
```vue
<line-chart :data="[['2026-01-01', 2], ['2026-01-02', 3]]"></line-chart>
```
...
function fetchData(success, fail) {
  success({"2026-01-01": 2, "2026-01-02": 3})
...
```vue
<line-chart xmin="2026-01-01" xmax="2026-02-01"></line-chart>
```
